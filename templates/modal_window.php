...
var launchWindow = function(id, screenshot_id) {
	...
	//$j(o).click(function(e) {
		...
		$j.ajax({
			...
			data: { ajaxcmd: 'get_screenshot_details', screenshot_id: screenshot_id},
			cache: false,
	                dataType: 'html',
...
<DIV STYLE="border-top:1px solid gray; overflow:hidden; padding-top:5px; margin-top:5px; min-width:698px; width:698px; max-width:698px; min-height:480px; height:480px; max-height:480px;">
